    ...
    <div className='w-screen h-[calc(100vh-4rem)]'>
      <div className="w-full h-[calc(100vh-4rem)] bg-black dark:bg-grid-white/[0.2] bg-grid-white/[0.2] relative flex items-center justify-center">
        ...
        <BackgroundLines className="flex items-center justify-center w-full flex-col px-4 bg-transparent z-10 ">
          <p className="text-center text-3xl lg:text-7xl md:text-5xl sm:text-4xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500 py-8">
            Welcome to <span className="inline-flex text-nowrap place-items-baseline  text-[#A704BF]"><img className=" w-[2rem] lg:w-[3.5rem] md:w-[2.5rem] sm:w-[2.5rem] inline" src="./kraken-2.svg" alt="" />KRAKEN</span> wallet
          </p>
